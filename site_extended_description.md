...
* 저작권자의 동의 없이 저작물을 영리적 목적으로 사용하였음이 신고됨. 단, 영리적 목적의 사용을 입증하지 못할 경우 직권처리 대상에서 제외됨.
...
본 인스턴스에서 발생하는 저작물은 별도의 저작권 표기가 없는 경우 [크리에이티브 커먼즈 저작자표시-비영리-동일조건변경허락 4.0 국제 라이선스 (CC BY-NC-SA 4.0)](https://creativecommons.org/licenses/by-nc-sa/4.0/)를 따릅니다.
...
이 규칙은 2023년 07월 07일 21:00 UTC+9(KST)부터 적용됩니다.
