...
* 특정 서버와 연합하는데 기술적 문제가 생길 경우 최대 72시간(3일) 동안 해당 서버와의 연합을 중단(셧다운)합니다. 타 서버와의 불필요한 갈등을 피하기 위해 연합 중단은 최대 72시간(3일)을 넘기지 않도록 하며, 72시간(3일) 후에도 기술적 문제가 해결되지 않은 경우 자체 공지 후 연합 재개 및 기술적 문제를 수용(문제를 해결하지 않음)합니다.
