...
* 우편 보내실 곳: (21582) 인천광역시 남동구 선수촌공원로23번길 11 502호 (구월동 1542-1) 내부 제35-16호 캐츠워즈리서치
...
본 인스턴스의 원활한 운영을 위해 수집된 개인정보가 국외로 이전될 수 있습니다. 자세한 내용은 [이 링크](hosting_locations.md)를 참고하시기 바랍니다.

본 인스턴스는 추적 방지 또는 이와 유사한 기술을 활용하여 정보를 탐색하고자 하는 이용자를 기술적으로 지원하고 있습니다. 단, 추적 방지는 쿠키 또는 이와 유사한 기술을 활용하는데 장애를 유발할 수 있으므로 추적 방지를 사용했을 때 본 인스턴스의 정상적 이용을 보장하지 않습니다.
...
이 개인정보 정책은 2023년 12월 07일 09:00 UTC+9(KST)부터 적용됩니다.
