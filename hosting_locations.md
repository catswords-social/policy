...
| 이용자 ID, 접속 IP     | 서비스 이용 시점에서 네트워크를 통한 전송 | 캐시(Cache) 등 콘텐츠 전송을 위한 임시 보유 | 이용 목적이 달성될 때 까지 | The Constant Company(미국) [#](https://www.constant.com/) | (FL 33401, US) 319 Clematis Street, Suite 900, West Palm Beach, 국내 데이터센터 위치: 삼성SDS IT센터 [#](https://www.peeringdb.com/asn/20473) |
...
| 이용자 ID, 접속 IP     | 서비스 이용 시점에서 네트워크를 통한 전송 | 캐시(Cache) 등 콘텐츠 전송을 위한 임시 보유 | 이용 목적이 달성될 때 까지 | NOCIX, LLC(미국) [#](https://www.nocix.net/)| (MO 64116, US) NOCIX, 201 East 16th Ave, North Kansas City, MO 64116 |
