...
| 이용자 ID              | 서비스 이용 시점에서 네트워크를 통한 전송 | 캐시(Cache) 등 콘텐츠 전송을 위한 임시 보유 | 이용 목적이 달성될 때 까지 | BrainStorm Network(캐나다) [#](https://oneprovider.com/about/company) | (H7L5A5, CA) 5A53275 Av Francis-Hughes, Laval, QC H7L 5A5 Canada |

1. 케이티클라우드(kt cloud)는 본사와 호스트 서버 소재지가 모두 대한민국이므로 개인정보국외이전 대상이 아닙니다.

마지막 갱신: 2023-08-12 03:18 UTC+9(KST)
