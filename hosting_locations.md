...
| 이용자 ID, 접속 IP     | 서비스 이용 시점에서 네트워크를 통한 전송 | 캐시(Cache) 등 콘텐츠 전송을 위한 임시 보유 | 이용 목적이 달성될 때 까지 | Intertech Services AG(스위스) [#](https://opencorporates.com/companies/ch/1045919) | (6005, CH) Citybay Business Center, Werftestrasse 4, CH 6005 Lucerne, Switzerland |

1. 케이티클라우드(kt cloud)는 본사와 호스트 서버 소재지가 모두 대한민국이므로 개인정보국외이전 대상이 아닙니다.

본 개인정보국외이전 고지 사항은 2023년 09월 13일 18:00 UTC+9(KST) 부터 적용됩니다.
